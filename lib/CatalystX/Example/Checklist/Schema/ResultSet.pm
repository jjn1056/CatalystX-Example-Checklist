package CatalystX::Example::Checklist::Schema::ResultSet;
...
CatalystX::Example::Checklist::Schema::ResultSet - A base ResultSet Class

=head1 SYNOPSIS

    package CatalystX::Example::Checklist::Schema::ResultSet::User;
    use parent 'CatalystX::Example::Checklist::Schema::ResultSet';
