package CatalystX::Example::Checklist::Schema::Result;
...
sub default_result_namespace { 'CatalystX::Example::Checklist::Schema::Result' }

1;

=head1 NAME

CatalystX::Example::Checklist::Schema::Result - The base result class

=head1 SYNOPSIS

	package CatalystX::Example::Checklist::Schema::Result::User;
    use parent 'CatalystX::Example::Checklist::Schema::Result';
